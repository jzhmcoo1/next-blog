...
import { Row, Col, Input, Select, Button, DatePicker, TimePicker, message } from 'antd'
...
function AddArticle(props) {
    ...
    const [articleId, setArticleId] = useState(0) //文章的ID,如果是0说明是新增加,不是0说明是修改
    ...
    const [showTime, setShowTime] = useState() //发布日期
